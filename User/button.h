...
#define		BUTTON_LONG_PRESS_TIME					(3000)		/* 1s */
...
uint8_t	button_init(button_t* button, uint32_t u, uint8_t hw_state_pressed, pf_button_read read, pf_button_callback callback);
